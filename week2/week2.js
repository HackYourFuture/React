...
var Button = function Button(_ref) {
  ...
  return React.createElement('input', { type: 'submit', value: text });
};
        ...
        React.createElement(
          ...
          items.map(function (item) {
            return React.createElement(
              ...
              React.createElement(Button, { type: 'button', text: 'Delete' })
            );
          })
        )
      );
...
var UserInput = function UserInput(_ref2) {
  ...
  return React.createElement(
    ...
    React.createElement('input', { type: 'date', name: 'date', min: new Date() }),
...
var App = function (_React$Component3) {
  ...
  function App(props) {
    ...
    _this3.deleteItem = function (index) {
      event.preventDefault();
      _this3.state.todoList.filter(function (item) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return React.createElement(
        'div',
        { className: 'panel' },
        React.createElement(UserInput, { addItem: this.addItem }),
        React.createElement(DynamicList, { items: this.state.todoList })
      );
    }
  }]);
