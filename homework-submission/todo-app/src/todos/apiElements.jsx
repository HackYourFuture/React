...
class Element extends Component {
    state = {
     ...
     throwLineHandle = () => {
        ...
        this.props.TodosStore.changeDoneValue(this.props.id);
     }
     ...
     submitUpdate = e => {
        ...
        const {id, description, deadline, done} = this.state;
        const item = {
            id: id,
        ...
        this.props.TodosStore.updateItem(id, item);
     }
    ...
    defaultItemsDisplay() {
        ...
        const defaultDate = new Date(deadline);
        const endDate = defaultDate.toLocaleString();
        const item = description + ', ' + endDate;
